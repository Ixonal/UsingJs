...
else if(b=U.exec(f.navigator.userAgent))a.name=V,a.version=+b[1];return{i:a}}function J(){g=G({},W,g,N());var a=X();if(null===a)throw Error("Could not locate the using.js script include. \nPlease specify the name of the source file in the configuration.");var b=a.getAttribute("data-script-root"),c=a.getAttribute("data-style-root"),d=a.getAttribute("data-using"),a=a.getAttribute("data-using-css");b&&"/"!==b.substr(b.length-1,1)&&(b+="/");g.F=b||"/";c&&"/"!==c.substr(c.length-1,1)&&(c+="/");g.G=c||
