...
(l.N()?G():setTimeout(c,a));J=!1},a)}}function K(a,b,c,g){var e,m,n,k,p,r,t=l.empty();switch(h(a,!0)){case "function":d.W(a);return;case "string":case "dependency":case "array":e=T.v(a);break;default:throw Error("Valid dependencies must be entered");}n=[];g?p=g:t||v?p=l.I():R()?(p=l.la())||(p=l.I()):"currentScript"in u&&((p=l.ka())||(p=l.I()));for(m=e.length;m--;){k=l.o(e[m]);if(!k){switch(h(e[m],!0)){case "string":r=!1;k=new q(e[m],B(e[m]),!1,null);break;case "dependency":r=e[m].dependsOn,k=new q(e[m].src,
B(e[m]),e[m].noExtension,e[m].backup,e[m].name,e[m].minified,e[m].exports)}l.O(k);r?function(){var a=k;K(e[m].dependsOn,function(){a.load()},null,a);a.C()}():k.C()}n.push(k)}if(p){for(m=n.length;m--;)p.J(n[m]),g&&n[m].A(b,n);b&&!g&&p.A(b,n);c&&(p.name=c)}else{a=new q("<||usingContext||>"+fa++,"<||usingContext||>",a.noExtension,a.backup,c,a.minified);l.O(a);for(m=n.length;m--;)a.J(n[m]);b&&a.A(b,n);c&&(a.name=c);a.C();t||v||R()||U.push(a)}"ie"===f.browser.name&&ea()}function d(a,b){K(a,b);return d}
...
}return 0===b.length?[a]:b}};w(q.prototype,{src:null,i:null,w:!1,type:"js",s:!1,status:0,g:null,b:null,j:null,F:null,a:null,l:null,name:null,D:!1,K:null,R:function(){if(6!==this.status){var a;for(a=this.g.length;a--;)this.g[a].matches(this)&&this.g.splice(a,1);for(a=this.b.length;a--;)this.b[a].matches(this)&&this.b.splice(a,1);delete this.g;delete this.b;delete this.j;delete this.a;delete this.a;delete this.src;delete this.i;delete this.w;delete this.type;this.status=6}},da:function(){var a;if(4===
this.status){this.status=7;for(a=this.b.length;a--;)8!==this.b[a].status&&this.b[a].u();this.M();this.status=8;E("dependency-status-terminal");for(a=this.g.length;a--;){var b=this.g[a];8!=b.status?b.u():b.M()}"<||page||>"!==this.type&&l.N()&&G()}},aa:function(a){switch(h(a,!0)){case "object":w(this.l,a);break;default:a&&(this.l=a)}},ea:function(a){var b,c,d={};a=a||this.b;for(b=a.length;b--;)if(c=a[b],da(c.l)){if(c.K){var e;a:{e=c.K.split(/[\.\/\\]+/);for(var f=k,n=void 0,h=void 0,n=0,h=e.length;n<
h;n++)if(f=f[e[n]],f===r){e=null;break a}e=f}S(d,c.name||c.src,e)}}else S(d,c.name||c.src,c.l);return d},u:function(){if(4===this.status||9===this.status)9===this.status?l.N()&&G():this.Y()&&this.da()},P:function(a){var b,c=this.b.length;a=a||[];for(a.push(this);c--;)if(b=this.b[c],-1!==x(a,b)){if(f.debug){var d="Cyclic dependency found (non-terminal): \n",e;for(e=0;e<a.length;e++)d+=a[e]===b?"---\x3e":"    ",d+=(a[e].name||a[e].src)+"\n";d+="---\x3e"+(b.name||b.src);P(d)}}else if(!b.X())return!1;
return!0},Y:function(a){return this.status in D&&this.P(a)},X:function(a){return this.status in L&&this.P(a)},J:function(a){if(!a||a.constructor!==q)throw Error("The other dependency must be a valid Dependency object.");this.matches(a)||(-1===F(this.b,a)&&(a.g.push(this),this.b.push(a)),4===a.status&&this.u())},M:function(a,b){a=(a||this.j).slice(0);b=(b||this.F).slice(0);if(this.Y())for(var c,d,e;(c=a.pop())&&(d=b.pop());){try{e=c.call(null,this.ea(d),this.l)}catch(f){this.error()}this.aa(e);c=x(this.j,
c);-1<c&&(this.j.splice(c,1),this.F.splice(c,1))}else for(d=a.length;d--;)this.A(a[d])},A:function(a,b){if("function"!==h(a))throw Error("dependency resolution callback function must be a function.");this.X()?this.M([a],[b]):-1===x(this.j,a)&&(this.j.push(a),this.F.push(b))},matches:function(a){var b=h(a);return"string"===b?this.src===a:"dependency"===b?this.src===a.src&&this.type==a.type:!1},ma:function(a){if(!this.matches(a)){var b=F(this.b,a);0<=b&&this.b.splice(b,1);b=F(a.g,this);0<=b&&a.g.splice(b,
1)}},resolve:function(){if(3===this.status){for(var a,b,c;(b=U.shift())!==r;)if("<||usingContext||>"===b.type&&6!==b.status){b.name&&(this.name=b.name);b.s&&(this.s=b.s);b.D!==r&&(this.D=b.D);b.i&&(this.i=b.i);b.l&&this.aa(b.l);for(a=b.b.length;a--;)c=b.b[a],this.J(c),b.ma(c);for(a=b.j.length;a--;)this.A(b.j[a],b.F[a]);l.Z(b);b.R()}this.status=4;this.u()}},error:function(a){var b,c;this.status=9;E("dependency-status-terminal");E("dependency-failed",{ca:this});b=this.w?this.i:this.src;"page"===b&&
...
"loaded"===a.a.readyState)a.a.onreadystatechange=null,a.status=3,a.resolve()},a.a.attachEvent&&a.a.attachEvent("onerror",b)):a.error("Unable to properly attach events with the current browser configuration.");f.scriptTag?f.scriptTag.parentElement.appendChild(a.a):u.getElementsByTagName("body")[0].appendChild(a.a)}else throw Error("This functionality is not yet implemented");}},C:function(){0===this.status&&("<||usingContext||>"!==this.type&&"<||page||>"!==this.type?(this.status=1,this.load()):(this.status=
4,this.u()))}});var l={c:{},G:0,ga:function(a){function b(a){var d=1,f,k=a.b.length,h;for(f=0;f<k;f++)h=a.b[f],-1===x(c,h)&&(d+=b(h)),c.push(h);return d}if(!a)return this.G;a=this.o(a);var c=[];return b(a)},fa:function(a){function b(a){var d=a.status in p?1:0,f,k=a.b.length,h;for(f=0;f<k;f++)h=a.b[f],-1===x(c,h)&&(d+=b(h)),c.push(h);return d}a=a?this.o(a):this.I();var c=[];return b(a)},H:null,B:[],ha:function(a){this.B.push(a);this.H&&this.S()},S:function(){for(var a=0,b=this.B.length;a<b;a++)this.B[a].call(null,
this.H.name||this.H.src);this.B.splice(0,this.B.length)},empty:function(){return 0===this.G},I:function(){if(this.c["<||page||>"])return this.c["<||page||>"];var a=new q("page","<||page||>");this.c["<||page||>"]=a;a.C();return a},la:function(){var a=u.getElementsByTagName("script"),b;for(b=0;b<a.length;b++)if("interactive"===a[b].readyState)return this.U(a[b]);return null},ka:function(){return this.U(u.currentScript)},U:function(a){if(!a)return null;for(var b in this.c){var c=this.c[b];if(c.a&&c.a===
a)return c}return null},o:function(a){switch(h(a)){case "string":return this.c[a]||null;case "dependency":return this.c[a.src]?this.c[a.src].type===(a.type||"js")?this.c[a.src]:null:null;default:return null}},O:function(a){if(!this.o(a)){var b;switch(h(a)){case "string":b=new q(a,"js");b.C();this.c[a]=b;break;case "dependency":this.c[a.src]=a}}this.G++;return this},Z:function(a){switch(h(a)){case "string":return this.Z(this.o(a));case "dependency":delete this.c[a.src],a.R()}this.G--;return this},
na:function(a){"array"!==h(a,!0)&&(a=[a]);for(var b=a.length;b--;)switch(h(a[b],!0)){case "string":if(!this.c[a])return!1;break;case "object":if(!this.c[a.src])return!1}return!0},N:function(){var a,b;for(a=this.c.length;a--;)if(b=this.c[a].status,b in p)return!1;return!0}},I=[],H=!1,J=!1;M("dependency-failed",function(a){l.H=a.ca;l.S()});var fa=0;d.ia=function(a,b,c){2===arguments.length&&(c=b,b=a,a=null);K(b,c,a);return d};d.amd=d.ia;d.T=function(a){if("function"!==typeof a)throw Error("callback must be a function");
l.ha(a)};d.failure=d.T;d.V=function(a){if("function"!==typeof a)throw Error("callback must be a function");M("dependency-status-terminal",function(){a.call(null,l.ga(),l.fa())})};d.progress=d.V;d.f=function(a,b){v=!0;switch(h(a,!0)){case "function":a.call(k);break;default:d(a,b)}v=!1;return d};d.page=d.f;d.f.f=function(a,b){v=!0;switch(h(a,!0)){case "function":a.call(k);break;default:d.h(a,b)}v=!1;return d};d.f.css=d.f.f;d.f.m=function(a){return d.V(a)};d.f.progress=d.f.m;d.f.h=function(a){return d.T(a)};
d.f.failure=d.f.h;d.W=function(a){I.push(a);return d};d.ready=d.W;d.ja=function(a){O(a);return d};d.config=d.ja;d.L=function(a,b,c){a&&d(b,c);return d};d.conditionally=d.L;d.m=function(a,b){T.ba(a,b);return d};d.alias=d.m;d.h=function(a,b){var c;switch(h(a,!0)){case "string":case "dependency":return d(C(a),b);case "array":for(c=a.length;c--;)a[c]=C(a[c]);return d(a,b);default:throw Error("Valid dependencies must be entered");}};d.css=d.h;d.h.L=function(a,b,c){a&&d.h(b,c);return d};d.h.conditionally=
d.h.L;d.h.m=function(a,b){return d.m(a,C(b))};d.h.alias=d.h.m;k.using=d;f.initialUsing&&d.f(f.initialUsing);f.initialStyleUsing&&d.f.f(f.initialStyleUsing);return d})();
